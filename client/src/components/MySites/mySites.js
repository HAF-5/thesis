        ...
        <div className="box">
          ...
          <div className="container filter">
            <div className="filter-view">
              ...
              >
                <svg viewBox="0 1 24 24" width="24" height="24">
                  <path d="M5,6 L5,7 L18,7 L18,6 L5,6 Z M19,6 L19,8 L4,8 L4,6 C4,5.44771525 4.44771525,5 5,5 L18,5 C18.5522847,5 19,5.44771525 19,6 Z M5,10 L5,11 L18,11 L18,10 L5,10 Z M19,9 L19,12 L4,12 L4,9 L19,9 Z M5,14 L5,15 L18,15 L18,14 L5,14 Z M19,13 L19,16 L4,16 L4,13 L19,13 Z M5,18 L5,19 L18,19 L18,18 L5,18 Z M19,17 L19,19 C19,19.5522847 18.5522847,20 18,20 L5,20 C4.44771525,20 4,19.5522847 4,19 L4,17 L19,17 Z"></path>
                </svg>{" "}
              </button>
            </div>
          </div>
          ...
          {this.state.isActive ? (
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="btn-group dropup ">
                            <button
                              class="btn dropdown-toggle option-site-list"
                            ...
                            <div class="dropdown-menu action-list site-list">
                              ...
                              >
                                <svg
                                  ...
                                  width="20"
                                  height="20"
                                  class="ListItemAction3311636269--prefixIcon"
                              ...
                              <button className="btn ">
                                <svg
                                  ...
                                  data-hook="list-item-action-prefix-icon"
                                >
                                  <path d="M18.5,5 L13,5 L12,5 L6.5,5 C5.673,5 5,5.673 5,6.5 L5,10 L6,10 L6,6.5 C6,6.224 6.225,6 6.5,6 L12,6 L12,18 L9,18 L9,19 L16,19 L16,18 L13,18 L13,6 L18.5,6 C18.775,6 19,6.224 19,6.5 L19,10 L20,10 L20,6.5 C20,5.673 19.327,5 18.5,5"></path>
                                </svg>
                                Rename Site
                              </button>
                              <button className="btn ">
            ...
            <div className="container flex-container">
              ...
              <div className="card container-div-create">
                <p className="div-text-create">
                  Start to Create a New Templete{" "}
                </p>
                <p className="pargraph-card-craete">Start Desgin Your Sites</p>
                <Link
                  to="/createProject"
                  className="btn btn-default btn-lg btn-create-div"
                >
                  Create New Website
                </Link>
              </div>
          ...
          >
            ...
            <div className="modal-content text-center">
              ...
              <div className="modal-body justify-content-center">
                ...
                ></i>
                <p>Do you really want to delete this website?</p>
              </div>
              {/* <!--Footer--> */}
              {this.props.websites.map(website => (
                <div className="modal-footer flex-center justify-content-center">
                  <a
                    ...
                    onClick={e => this.deleteWebsite(e, website._id)}
                    data-dismiss="modal"
                  >
                    Yes
                  </a>
